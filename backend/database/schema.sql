...
CREATE TABLE IF NOT EXISTS projects (
  ...
  category VARCHAR(50) NOT NULL CHECK (category IN ('DeFi', 'NFT', 'Gaming', 'Infrastructure', 'DAO', 'DePIN', 'Social', 'Mobile', 'Security', 'Payment', 'Developer Tooling', 'ReFi', 'Content', 'Dapp', 'Blinks')),
