-- =============================================================================
-- FILE 1/2: Wipe public schema + create clean tables
-- =============================================================================
-- Run in Supabase SQL Editor (or: psql "$DATABASE_URL" -f 01_wipe_and_schema.sql)
-- WARNING: deletes ALL tables/data in schema public.
-- After this, run 02_data_clean.sql to restore cleaned prod data.
-- =============================================================================
...
-- Schema objects (tables, indexes, RLS, seeds)
