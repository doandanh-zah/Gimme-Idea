...
// Editorial badge for Gimme Sensei AI comments — matches builder UI (sharp, mono, gold)
export function GimmeSenseiBadge({ className = '' }: { className?: string }) {
  return (
    <span
      className={`inline-flex items-center gap-1.5 border border-[#FFD700]/40 bg-[#FFD700]/[0.08] px-1.5 py-0.5 font-mono text-[10px] font-semibold uppercase tracking-[0.12em] text-[#FFD700] ${className}`}
      title="AI Mentor — generated by Gimme Sensei"
    >
