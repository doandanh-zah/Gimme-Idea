                ...
                <form onSubmit={handleSubmit} className="space-y-6 bg-[#0F0F1A]/80 backdrop-blur-xl p-8 rounded-3xl border border-white/10 shadow-2xl relative overflow-hidden group">
                    ...
                    <div>
                        ...
                        <div
                            ...
                            className={`relative border-2 border-dashed rounded-xl p-10 text-center transition-all cursor-pointer overflow-hidden group/upload ${isUploadingImage ? 'border-accent/50 bg-black/40 cursor-wait' :
