    ...
    <section className="py-24 px-6 relative bg-gradient-to-b from-transparent via-[#000000]/60 to-[#000000]/80">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-6 lg:gap-8 relative z-10">
            {JOURNEY_STEPS.map((step, index) => (
              ...
              >
                ...
                {/* Arrow between steps (hide on last and on small screens) */}
                {index < JOURNEY_STEPS.length - 1 && (
                  <div className="hidden lg:flex absolute top-1/2 -right-4 transform -translate-y-1/2 text-gray-600">
