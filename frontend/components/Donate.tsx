                                    ...
                                    >
                                        ...
                                        <button
                                            onClick={() => {
                                                ...
                                                const message = contributorName ? `from ${contributorName} with love` : 'Supporting GimmeIdea';
                                            ...
                                            className="w-full py-4 bg-white/5 border border-white/10 rounded-xl font-bold text-white hover:bg-white/10 transition-colors shadow-lg shadow-white/5 flex items-center justify-center gap-2 text-lg mb-4"
                                        >
