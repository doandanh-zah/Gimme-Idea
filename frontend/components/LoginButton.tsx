  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <motion.button
        ...
        className="flex items-center gap-2 px-5 py-2.5 bg-white text-black rounded-full font-bold text-sm hover:bg-gray-100 transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.2)] whitespace-nowrap disabled:opacity-70 disabled:cursor-not-allowed"
      >
        {loadingGoogle ? (
          <>
