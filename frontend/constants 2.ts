...
export const PROJECTS: Project[] = [
  {
    ...
    comments: [
      ...
      { 
        id: 'c2', 
        author: 'sol_fan', 
        content: 'Latency is looking good on devnet.', 
        timestamp: '5h ago',
        likes: 5,
        dislikes: 1,
        tips: 0,
        replies: [
          {
            id: 'c2-r1',
            author: 'stream_wizard',
            content: 'Thanks! We optimized the encoding pipeline last week.',
            timestamp: '4h ago',
            likes: 2,
            dislikes: 0,
            tips: 0,
  ...
  },
  {
    ...
    comments: [
        { 
          id: 'c3', 
          author: 'gamer_xyz', 
          content: 'The loot drop rates feel a bit low on level 3.', 
          timestamp: '1d ago',
          likes: 8,
          dislikes: 2,
          tips: 0,
