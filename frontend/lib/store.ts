...
interface AppState {
  ...
  hydrateProjectsFromQuery: (params: {
    projects: Project[];
    hasMoreProjects: boolean;
    projectsOffset: number;
  }) => void;
  hydrateProjectDetailFromQuery: (project: Project) => void;
...
export const useAppStore = create<AppState>((set, get) => ({
  ...
  hydrateProjectsFromQuery: ({ projects, hasMoreProjects, projectsOffset }) => {
    set({
      projects,
      hasMoreProjects,
      projectsOffset,
  ...
  hydrateProjectDetailFromQuery: (project) => {
    set((state) => {
