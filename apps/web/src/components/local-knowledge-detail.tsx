...
const labels = {
  ...
  vi: {
    back: 'Quay lại',
    notFound: 'Không tìm thấy bài đã lưu trên thiết bị này.',
    problem: 'Vấn đề',
    idea: 'Ý tưởng',
    oneLine: 'Mô tả 1 câu',
    who: 'Ai đang gặp vấn đề này?',
    why: 'Vì sao vấn đề này quan trọng?',
    opportunity: 'Cơ hội',
    solution: 'Giải pháp',
    primaryProblem: 'Vấn đề chính',
    moreDetails: 'Chi tiết thêm',
    media: 'Ảnh và video',
    ideas: 'Ý tưởng cho vấn đề này',
    noIdeas: 'Chưa có ý tưởng nào được lưu trên thiết bị cho vấn đề này.',
    bounty: 'Bounty',
    hiring: 'Tuyển dụng',
  },
} as const;
